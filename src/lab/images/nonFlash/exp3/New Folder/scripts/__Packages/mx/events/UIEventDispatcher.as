class mx.events.UIEventDispatcher extends mx.events.EventDispatcher
{
   ...
   function dispatchEvent(eventObj)
   {
      ...
      this.§com.jpexs.decompiler.flash.action.model.operations.AddActionItem§(eventObj);
      ...
      if(this[_loc6_].length == 0)
      {
         ...
         for(var _loc5_ in _loc2_)
         {
            if(!(mx.events.UIEventDispatcher[_loc5_][event] == undefined))
            {
               ...
               mx.events.UIEventDispatcher.§com.jpexs.decompiler.flash.action.model.GetMemberActionItem§(this);
            }
         }
      }
      if(this[_loc6_].length == 0)
