...
* Objective
  - To view the Simulation of the Load Transfer from one Feeder to other during Transformer Maintenance experiment
...
* Test Steps
  ...
  3. Click on the ON button of forced operation control for all the GOS

* Expected result
  1. Simulation page should be opened
  2. Content should be present with no distortions and Junk characters
  3. Once G.O.S is closed the color of display of G.O.S changes and also status in G.O.S status table is indicated as close and forced operation is indicated as open.
