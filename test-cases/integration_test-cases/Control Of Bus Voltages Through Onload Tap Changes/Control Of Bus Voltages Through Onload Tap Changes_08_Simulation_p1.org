...
* Test Steps
  ...
  4. Increase the tap value by clicking on the raise button

* Expected result
  1. Simulation page should be opened
  2. Content should be present with no distortions and Junk characters
  3. One click on raise button,should change tap by 1.25% and should alter voltages correspondingly
